	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            { className: 'md-col-4 mx-auto px2' },
	            this.props.description + ' ',
	            _react2.default.createElement(
	              'a',
	              { className: 'black', href: 'https://twitter.com/drip', target: '_blank' },
	              this.props.employer
	            ),
	            '.'
	          )
